...
/*        LocationObject location = new LocationObject();
        ...
        driver.setName("Mourad");
        driver.setActive(true);
        driver.setCar("231-abc");
        driver.setPhone("444543564");
        driver.setRatingsAvg(3);
        driver.setLocation(LocationObject.getDriverStartLocation());
        driver.payoutAmount = 2341;
        driver.license = "123-licence-egypt";
        return driver;
    }
}
