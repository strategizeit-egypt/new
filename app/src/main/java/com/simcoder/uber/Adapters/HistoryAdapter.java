...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.HistoryViewHolders> implements OnMapReadyCallback {
    ...
    class HistoryViewHolders extends RecyclerView.ViewHolder implements OnMapReadyCallback {
        ...
        private void setMapLocation() {
            ...
            builder.include(new LatLng(29.99978818913346, 31.14007785916328));
            builder.include(new LatLng(29.990755
                    ,31.151274999999998));
         //   builder.include(new LatLng(0,0));
            ...
            map.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_finish)).position(new LatLng(29.99978818913346, 31.14007785916328)).title("destination"));
            map.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_start)).position(new LatLng(29.990755
                    ,31.151274999999998)).title("pickup"));
